...
3. **Registration**: Use the command: `gemini mcp add private-tools <venv_path>/bin/python <project_path>/main.py --trust`.
...
2. **Registration Function**: Implement a `register_<module_name>_tools(mcp: FastMCP)` function.
